!########################################################################
! EXERCISE 4 INFORMATION THEORY AND COMPUTATION course,
! master degree in physics of data, university of Padova, November 2019
! Davide Maniscalco
!--------------------------------------------------------------------
! MATRIX MULTIPLICATION with INPUT DIMENSIONS READ FROM FILE
! ------------------------------------------------------------------
...
PROGRAM MATRIX_MULTIPLICATION
      ...
      INTEGER ii,jj,kk,nn,mm,ll,nndim,ss,length,reason
...
! first iteration: if the file already exists, it is replaced. Other iterations: append
IF (ss==1) THEN
...
WRITE(30,*) T6-T5
 ...
 CLOSE(30)
!----------------------------------------------------------------
! Printing of the matrix dimension to see the progress
!----------------------------------------------------------------
